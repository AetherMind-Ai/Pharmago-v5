    ...
    <div className="container mx-auto px-4 py-8 pt-[80px]">
      <div className="flex flex-col lg:flex-row gap-8">
        <div className="w-full lg:w-1/3">
          ...
          <div
            ref={containerRef}
            className="relative overflow-hidden rounded-lg shadow-md cursor-zoom-in border"
          ...
          >
            <img
              ...
              src={product.image}
              alt={product.name}
              className="w-full h-auto object-cover" // Base styles, transform is handled by JS
            />
          </div>
        </div>
